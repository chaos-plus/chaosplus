---
title: "项目说明"
description: "由 README.md 同步的工程文档"
editUrl: false
---
...
[架构文档](/architecture/iam-platform/)。
访问申请、四眼审批与临时授权契约见
[访问治理](/iam/access-governance/)。

Production bootstrap, Docker Compose quick start, TLS, and external-service
configuration are documented in [部署指南](/operations/deployment/).
...
- **Self-hosted IAM** — local principals, Argon2id credentials, opaque browser
  ...
  [SCIM provisioning](/iam/scim-provisioning/).
