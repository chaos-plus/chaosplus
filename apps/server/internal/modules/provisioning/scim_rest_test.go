...
func TestSCIMHTTPErrorPathsAreLocalized(t *testing.T) {
	...
	unauthorized := []struct {
		...
		{http.MethodGet, "/scim/v2/Users/" + wireID("missing"), nil},
		{http.MethodPut, "/scim/v2/Users/" + wireID("missing"), userBody},
		{http.MethodPatch, "/scim/v2/Users/" + wireID("missing"), patchBody},
		{http.MethodDelete, "/scim/v2/Users/" + wireID("missing"), nil},
		{http.MethodGet, "/scim/v2/Groups", nil},
		{http.MethodPost, "/scim/v2/Groups", groupBody},
		{http.MethodGet, "/scim/v2/Groups/" + wireID("missing"), nil},
		{http.MethodPut, "/scim/v2/Groups/" + wireID("missing"), groupBody},
		{http.MethodPatch, "/scim/v2/Groups/" + wireID("missing"), patchBody},
		{http.MethodDelete, "/scim/v2/Groups/" + wireID("missing"), nil},
	...
	tests := []struct {
		...
		{"missing user", http.MethodGet, "/scim/v2/Users/" + wireID("missing"), nil, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"replace user etag", http.MethodPut, "/scim/v2/Users/" + wireID("missing"), userBody, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"replace user malformed body", http.MethodPut, "/scim/v2/Users/" + wireID("missing"), []byte(`{`), nil, http.StatusBadRequest, "scim_invalid_syntax"},
		{"replace missing user", http.MethodPut, "/scim/v2/Users/" + wireID("missing"), userBody, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"patch user etag", http.MethodPatch, "/scim/v2/Users/" + wireID("missing"), patchBody, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"patch user malformed body", http.MethodPatch, "/scim/v2/Users/" + wireID("missing"), []byte(`{`), nil, http.StatusBadRequest, "scim_invalid_syntax"},
		{"patch missing user", http.MethodPatch, "/scim/v2/Users/" + wireID("missing"), patchBody, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"delete user etag", http.MethodDelete, "/scim/v2/Users/" + wireID("missing"), nil, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"delete missing user", http.MethodDelete, "/scim/v2/Users/" + wireID("missing"), nil, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"missing group", http.MethodGet, "/scim/v2/Groups/" + wireID("missing"), nil, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"replace group etag", http.MethodPut, "/scim/v2/Groups/" + wireID("missing"), groupBody, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"replace group malformed body", http.MethodPut, "/scim/v2/Groups/" + wireID("missing"), []byte(`{`), nil, http.StatusBadRequest, "scim_invalid_syntax"},
		{"replace missing group", http.MethodPut, "/scim/v2/Groups/" + wireID("missing"), groupBody, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"patch group etag", http.MethodPatch, "/scim/v2/Groups/" + wireID("missing"), patchBody, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"patch group malformed body", http.MethodPatch, "/scim/v2/Groups/" + wireID("missing"), []byte(`{`), nil, http.StatusBadRequest, "scim_invalid_syntax"},
		{"patch missing group", http.MethodPatch, "/scim/v2/Groups/" + wireID("missing"), patchBody, nil, http.StatusNotFound, "scim_resource_not_found"},
		{"delete group etag", http.MethodDelete, "/scim/v2/Groups/" + wireID("missing"), nil, map[string]string{"If-Match": "1"}, http.StatusPreconditionFailed, "scim_version_conflict"},
		{"delete missing group", http.MethodDelete, "/scim/v2/Groups/" + wireID("missing"), nil, nil, http.StatusNotFound, "scim_resource_not_found"},
