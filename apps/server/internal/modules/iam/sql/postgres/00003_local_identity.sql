...
CREATE TABLE iam_refresh_tokens (
    ...
    client_id VARCHAR(128) NOT NULL, scope TEXT NOT NULL DEFAULT '', created_at BIGINT NOT NULL,
...
CREATE TABLE iam_oauth_clients (
    id VARCHAR(128) PRIMARY KEY, tenant_id VARCHAR(128) NOT NULL, secret_hash TEXT NOT NULL DEFAULT '', name VARCHAR(128) NOT NULL,
...
CREATE TABLE iam_entities (
    tenant_id VARCHAR(128) NOT NULL, id VARCHAR(64) NOT NULL, parent_id VARCHAR(64), type VARCHAR(64) NOT NULL,
