...
CREATE TABLE workspace_requirements (
 ...
 parent_id BIGINT NULL CHECK(parent_id IS NULL OR parent_id>0), title VARCHAR(300) NOT NULL CHECK(char_length(title) BETWEEN 1 AND 300), description TEXT NOT NULL DEFAULT '', acceptance_criteria TEXT NOT NULL DEFAULT '',
