...
CREATE TABLE workspace_requirement_key_results (
 ...
 FOREIGN KEY(requirement_id) REFERENCES workspace_requirements(id) ON DELETE CASCADE,
 FOREIGN KEY(key_result_id) REFERENCES workspace_key_results(id) ON DELETE RESTRICT
);
