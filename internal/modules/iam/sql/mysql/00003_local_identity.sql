...
CREATE TABLE iam_principals (
    id VARCHAR(64) PRIMARY KEY, login_name VARCHAR(200) NOT NULL UNIQUE, email VARCHAR(320) NOT NULL DEFAULT '',
...
CREATE TABLE iam_credentials (
    principal_id VARCHAR(64) PRIMARY KEY, password_hash TEXT NOT NULL, totp_secret TEXT NOT NULL,
...
CREATE TABLE iam_refresh_tokens (
    ...
    client_id VARCHAR(128) NOT NULL, scope TEXT NOT NULL, created_at BIGINT NOT NULL,
...
CREATE TABLE iam_oauth_clients (
    id VARCHAR(128) PRIMARY KEY, tenant_id VARCHAR(128) NOT NULL, secret_hash TEXT NOT NULL, name VARCHAR(128) NOT NULL, redirect_uris TEXT NOT NULL,
...
CREATE TABLE iam_entities (
    tenant_id VARCHAR(128) NOT NULL, id VARCHAR(64) NOT NULL, parent_id VARCHAR(64) NULL, type VARCHAR(64) NOT NULL,
...
CREATE TABLE iam_audit_events (
    id VARCHAR(64) PRIMARY KEY, tenant_id VARCHAR(128) NOT NULL DEFAULT '', principal_id VARCHAR(64) NOT NULL DEFAULT '',
