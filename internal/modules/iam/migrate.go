...
func AssertMigrated(ctx context.Context, db *bun.DB) error {
	for _, table := range []string{"iam_tenant_members", "iam_policy_revisions", "iam_platform_administrators", "iam_service_accounts", "iam_relationships", "iam_resource_relationships", "iam_temporary_role_grants"} {
